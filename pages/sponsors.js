    ...
    <Layout>
      <div className="relative overflow-hidden min-h-screen">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 text-center">
          ...
          <p className="mb-8">
            We’re incredibly grateful to the organizations and individuals who support Ethan and Ryan on their journey to the world stage.
          </p>
          ...
          <p className="mt-10">
            Interested in sponsoring? <a href="/contact" className="text-blue-600 underline">Get in touch</a> to learn more about sponsorship benefits!
          </p>
        </div>
      </div>
    </Layout>
